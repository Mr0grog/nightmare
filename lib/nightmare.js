...
function Nightmare(options) {
  ...
  function logFromChild(messageName) {
    this.child.on(messageName, function() {
      log(messageName, JSON.stringify(Array.prototype.slice.call(arguments)));
    });
  }
  logFromChild.call(this, 'move');
  logFromChild.call(this, 'close');
  logFromChild.call(this, 'unresponsive');
  logFromChild.call(this, 'responsive');
  logFromChild.call(this, 'render-view-deleted');
  logFromChild.call(this, 'did-navigate');
  logFromChild.call(this, 'did-navigate-in-page');
  logFromChild.call(this, 'will-destroy');
  logFromChild.call(this, 'navigation-entry-committed');
  logFromChild.call(this, 'cursor-changed');
  logFromChild.call(this, 'console-message');
}
